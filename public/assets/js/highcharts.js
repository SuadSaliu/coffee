...
*/
(function(X, Q) {
    "object" === typeof module && module.exports ? (Q["default"] = Q,
    module.exports = X.document ? Q(X) : Q) : "function" === typeof define && define.amd ? define("highcharts/highcharts", function() {
        return Q(X)
    }) : (X.Highcharts && X.Highcharts.error(16, !0),
    X.Highcharts = Q(X))
}
    ...
    Q(A, "parts/Utilities.js", [A["parts/Globals.js"]], function(d) {
        function f() {
            var a, c = arguments, k = {}, r = function(a, c) {
                "object" !== typeof a && (a = {});
                Z(c, function(k, e) {
          ...
          , H = function() {
            ...
            a.prototype.update = function() {
                ...
                if (this[c + "Setter"])
                    ...
                    a.attr ? a.element && a.attr(c, k, null, !0) : a.style[c] = k + this.unit;
                r && r.call(a, k, this)
            }
            ;
            a.prototype.run = function(a, c, k) {
                ...
                a !== c || this.elem["forceAnimate:" + this.prop] ? (this.startTime = +new Date,
                this.start = a,
                this.end = c,
                this.unit = k,
                this.now = this.start,
                ...
                z.elem = this.elem,
                z.prop = this.prop,
                z() && 1 === d.timers.push(z) && b(l)) : (delete e.curAnim[this.prop],
        ...
        var p = d.css = function(a, c) {
          ...
          , B = d.normalizeTickInterval = function(a, c, k, r, e) {
            ...
            k = M(k, 1);
            var b = a / k;
            c || (c = e ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10],
            !1 === r && (1 === k ? c = c.filter(function(a) {
                return 0 === a % 1
            }) : .1 >= k && (c = [1 / k])));
            for (r = 0; r < c.length && !(z = c[r],
            e && z * k >= a || !e && b <= (c[r] + (c[r + 1] || c[r])) / 2); r++)
                ;
          ...
          , T = d.numberFormat = function(a, c, k, r) {
            ...
            if (-1 === c)
                ...
                var l = c + +b[1];
                0 <= l ? (b[0] = (+b[0]).toExponential(l).split("e")[0],
                c = l) : (b[0] = b[0].split(".")[0] || 0,
        ...
        var ca = d.getStyle = function(a, c, k) {
            if ("width" === c)
                return c = Math.min(a.offsetWidth, a.scrollWidth),
            ...
            if ("height" === c)
                return Math.max(0, Math.min(a.offsetHeight, a.scrollHeight) - d.getStyle(a, "padding-top") - d.getStyle(a, "padding-bottom"));
            x.getComputedStyle || F(27, !0);
            if (a = x.getComputedStyle(a, void 0))
                a = a.getPropertyValue(c),
                M(k, "opacity" !== c) && (a = C(a));
            return a
        }
        ...
        var ha = d.addEvent = function(a, c, k, r) {
          ...
          , A = d.animate = function(a, c, k) {
            ...
            Z(c, function(l, g) {
                ...
                b = new H(a,k,g);
                z = null;
                "d" === g && w(c.d) ? (b.paths = b.initPath(a, a.pathArray, c.d),
                b.toD = c.d,
                r = 0,
                z = 1) : a.attr ? r = a.attr(g) : (r = parseFloat(ca(a, g)) || 0,
                "opacity" !== g && (e = "px"));
                z || (z = l);
        ...
        x.jQuery && (x.jQuery.fn.highcharts = function() {
            ...
            if (this[0])
                return a[0] ? (new (d[D(a[0]) ? a.shift() : "Chart"])(this[0],a[0],a[1]),
        ...
        f = function() {
            ...
            d.prototype.get = function(d) {
                ...
                if ("undefined" !== typeof this.stops) {
                    ...
                    F = x && E(x[0]) ? "rgb" === d || !d && 1 === x[3] ? "rgb(" + x[0] + "," + x[1] + "," + x[2] + ")" : "a" === d ? x[3] : "rgba(" + x.join(",") + ")" : f;
                return F
            }
            ;
            ...
            d.prototype.tweenTo = function(d, f) {
                var x = this.rgba
                  , q = d.rgba;
                q.length && x && x.length ? (d = 1 !== q[3] || 1 !== x[3],
                f = (d ? "rgba(" : "rgb(") + Math.round(q[0] + (x[0] - q[0]) * (1 - f)) + "," + Math.round(q[1] + (x[1] - q[1]) * (1 - f)) + "," + Math.round(q[2] + (x[2] - q[2]) * (1 - f)) + (d ? "," + (q[3] + (x[3] - q[3]) * (1 - f)) : "") + ")") : f = d.input || "none";
                return f
            }
            ;
            d.names = {
    ...
    Q(A, "parts/SVGElement.js", [A["parts/Color.js"], A["parts/Globals.js"], A["parts/Utilities.js"]], function(d, f, E) {
        ...
        E = function() {
            ...
            B.prototype.add = function(c) {
                ...
                this.added = !0;
                if (!c || c.handleZ || this.zIndex)
                    var r = this.zIndexSetter();
            ...
            B.prototype.align = function(c, a, k) {
                ...
                var h, p;
                if (c) {
                    if (this.alignOptions = c,
                    this.alignByTranslate = a,
                    !k || l(k))
                        this.alignTo = r = k || "renderer",
                        m(g, this),
                        g.push(this),
                        k = void 0
                } else
            ...
            B.prototype.animate = function(c, a, k) {
                ...
                0 !== r.duration ? (k && (r.complete = k),
                C(this, c, r)) : (this.attr(c, void 0, k),
                u(c, function(a, c) {
            ...
            B.prototype.applyTextOutline = function(c) {
                ...
                if ((k = c[0]) && "none" !== k && f.svg) {
                    ...
                    c.forEach(function(c, z) {
                        0 === z && (c.setAttribute("x", a.getAttribute("x")),
                        z = a.getAttribute("y"),
            ...
            B.prototype.attr = function(c, a, k, r) {
                var e = this.element, b, l = this, g, h, p = this.symbolCustomAttribs;
                ...
                "string" === typeof c ? l = (this[c + "Getter"] || this._defaultGetter).call(this, c, e) : (u(c, function(a, k) {
                    g = !1;
                    r || S(this, k);
                    this.symbolName && -1 !== v(k, p) && (b || (this.symbolAttr(c),
                    b = !0),
                    g = !0);
                    !this.rotation || "x" !== k && "y" !== k || (this.doTransform = !0);
                    g || (h = this[k + "Setter"] || this._defaultSetter,
                    h.call(this, a, k, e),
                    !this.styledMode && this.shadows && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(k) && this.updateShadows(k, a, h))
                }, this),
                this.afterSetters());
                k && k.call(this);
                return l
            ...
            B.prototype.complexColor = function(c, a, k) {
                var r = this.renderer, e, b, l, p, m, v, y, n, O, V, t = [], G;
                g(this.renderer, "complexColor", {
                    ...
                    if (b) {
                        ...
                        "radialGradient" === b && O && !N(l.gradientUnits) && (p = l,
                        l = I(l, r.getRadialAttr(O, p), {
                            gradientUnits: "userSpaceOnUse"
                        }));
                        u(l, function(a, c) {
                            "id" !== c && t.push(c, a)
                        ...
                        if (m[t])
                            ...
                            v.forEach(function(a) {
                                0 === a[1].indexOf("rgba") ? (e = d.parse(a[1]),
                                y = e.get("rgb"),
                                n = e.get("a")) : (y = a[1],
                                n = 1);
            ...
            B.prototype.getBBox = function(c, a) {
                var k, r = this.renderer, z = this.element, l = this.styles, g = this.textStr, h = r.cache, p = r.cacheKeys, u = z.namespaceURI === this.SVG_NS;
            ...
            B.prototype.setTextPath = function(c, a) {
                ...
                var g = a.attributes;
                if (c && a && a.enabled) {
                    b && null === b.element.parentNode ? (l = !0,
                    b = b.destroy()) : b && this.removeTextOutline.call(b.parentGroup, [].slice.call(k.getElementsByTagName("tspan")));
                    this.options && this.options.padding && (g.dx = -this.options.padding);
                    b || (this.textPathWrapper = b = this.renderer.createElement("textPath"),
                    e = !0);
                    var h = b.element;
                    ...
                    N(g.dy) && (h.parentNode.setAttribute("dy", g.dy),
                    delete g.dy);
                    N(g.dx) && (h.parentNode.setAttribute("dx", g.dx),
                    delete g.dx);
                    u(g, function(a, c) {
            ...
            B.prototype.shadow = function(c, a, k) {
                ...
                if (!p)
                    ...
                    for (h = 1; h <= p.width; h++) {
                        ...
                        k && (w(y, "height", Math.max(w(y, "height") - O, 0)),
                        y.cutHeight = O);
            ...
            B.prototype.strokeSetter = function(c, a, k) {
                this[a] = c;
                this.stroke && this["stroke-width"] ? (B.prototype.fillSetter.call(this, this.stroke, "stroke", k),
                k.setAttribute("stroke-width", this["stroke-width"]),
                this.hasStroke = !0) : "stroke-width" === a && 0 === c && this.hasStroke ? (k.removeAttribute("stroke"),
                this.hasStroke = !1) : this.renderer.styledMode && this["stroke-width"] && (k.setAttribute("stroke-width", this["stroke-width"]),
                this.hasStroke = !0)
            }
            ;
            ...
            B.prototype.textSetter = function(c) {
                c !== this.textStr && (delete this.textPxLength,
                this.textStr = c,
            ...
            B.prototype.titleSetter = function(c) {
                ...
                a || (a = M.createElementNS(this.SVG_NS, "title"),
            ...
            B.prototype.zIndexSetter = function(c, a) {
                ...
                var g = this.added;
                var h;
                N(c) ? (b.setAttribute("data-z-index", c),
                c = +c,
                this[a] === c && (g = !1)) : N(this[a]) && b.removeAttribute("data-z-index");
                this[a] = c;
                if (g) {
                    ...
                    for (h = a.length - 1; 0 <= h && !l; h--) {
                        ...
                        if (r !== b)
                            if (0 > c && p && !k && !h)
                                e.insertBefore(b, a[h]),
                                l = !0;
                            else if (G(g) <= c || p && (!N(c) || 0 <= c))
                                e.insertBefore(b, a[h + 1] || null),
                                l = !0
                    }
                    l || (e.insertBefore(b, a[k ? 3 : 0] || null),
                    l = !0)
                }
                return l
            }
    ...
    Q(A, "parts/SvgRenderer.js", [A["parts/Color.js"], A["parts/Globals.js"], A["parts/SVGElement.js"], A["parts/Utilities.js"]], function(d, f, E, q) {
        ...
        C(d.prototype, {
                ...
                var k = this, z = a.rotation, h, p = e ? 1 : 0, u = (r || e).length, P = u, m = [], v = function(a) {
                    ...
                    if ("undefined" === typeof m[z])
                        if (c.getSubStringLength)
                            ...
                            k.getSpanWidth && (v(g(r || e, l)),
                            m[z] = b + k.getSpanWidth(a, c));
                    return m[z]
                }, n;
                a.rotation = 0;
            ...
            buildText: function(a) {
                var c = a.element, r = this, e = r.forExport, l = b(a.textStr, "").toString(), h = -1 !== l.indexOf("<"), p = c.childNodes, u, v = J(c, "x"), y = a.styles, n = a.textWidth, O = y && y.lineHeight, V = y && y.textOutline, t = y && "ellipsis" === y.textOverflow, G = y && "nowrap" === y.whiteSpace, d = y && y.fontSize, w, B = p.length;
                ...
                var f = function(a) {
                  ...
                  , C = function(a, c) {
                    ...
                    k = a.indexOf(c + "=");
                    if (-1 !== k && (k = k + c.length + 1,
                    c = a.charAt(k),
                    '"' === c || "'" === c))
                        return a = a.substring(k + 1),
                        a.substring(0, a.indexOf(c))
                }
                  , D = /<br.*?>/g;
                ...
                if (q !== a.textCache) {
                    for (a.textCache = q; B--; )
                        c.removeChild(p[B]);
                    h || V || t || n || -1 !== l.indexOf(" ") && (!G || D.test(l)) ? (y && y.appendChild(c),
                    h ? (l = r.styledMode ? l.replace(/<(b|strong)>/g, '<span class="highcharts-strong">').replace(/<(i|em)>/g, '<span class="highcharts-emphasized">') : l.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">'),
                    l = l.replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(D)) : l = [l],
                    ...
                    l.forEach(function(k, b) {
                        ...
                        z.forEach(function(k) {
                            if ("" !== k || 1 === z.length) {
                                var h = {}, p = I.createElementNS(r.SVG_NS, "tspan"), m, P;
                                (m = C(k, "class")) && J(p, "class", m);
                                if (m = C(k, "style"))
                                    m = m.replace(/(;| |^)color([ :])/, "$1fill$2"),
                                    J(p, "style", m);
                                (P = C(k, "href")) && !e && (J(p, "onclick", 'location.href="' + P + '"'),
                                ...
                                if (" " !== k) {
                                    ...
                                    if (n) {
                                        ...
                                        if (t)
                                            ...
                                            for (; O.length; )
                                                O.length && !G && 0 < P && (p = I.createElementNS(R, "tspan"),
                                                J(p, {
                                                    dy: y,
                                                    x: v
                                                }),
                    ...
                    y && y.removeChild(c),
                    V && a.applyTextOutline && a.applyTextOutline(V)) : c.appendChild(I.createTextNode(N(l)))
                }
            },
            ...
            rect: function(a, c, r, e, b, l) {
                ...
                this.styledMode || ("undefined" !== typeof l && (a.strokeWidth = l,
                a = k.crisp(a)),
                a.fill = "none");
                b && (a.r = b);
            ...
            image: function(a, k, r, e, b, l) {
                ...
                K(g, "load", z),
                g.src = a,
                g.complete && z({})) : h(p.element, a);
                return p
            },
            symbol: function(a, c, r, e, l, g) {
                var k = this, h = /^url\((.*?)\)$/, z = h.test(a), u = !z && (this.symbols[a] ? a : "circle"), m = u && this.symbols[u], v;
                if (m) {
                    ...
                    ["width", "height"].forEach(function(a) {
                        P[a + "Setter"] = function(a, c) {
                            ...
                            this[c] = a;
                            F(r) && (g && "within" === g.backgroundSize && this.width && this.height && (r = Math.round(r * Math.min(this.width / this.imgwidth, this.height / this.imgheight))),
                            this.element && this.element.setAttribute(c, r),
                            this.alignByTranslate || (k[e] = ((this[c] || 0) - r) / 2,
                            this.attr(k)))
                        }
                    });
                    F(c) && P.attr({
            ...
            text: function(a, c, e, b) {
                ...
                if (b && (this.allowHTML || !this.forExport))
                    return this.html(a, c, e);
                k.x = Math.round(c || 0);
                e && (k.y = Math.round(e));
                F(a) && (k.text = a);
                a = this.createElement("text").attr(k);
                b || (a.xSetter = function(a, c, k) {
                    var e = k.getElementsByTagName("tspan"), r = k.getAttribute(c), b;
            ...
            pathToSegments: function(a) {
                for (var c = [], e = [], b = {
                    ...
                    t(e[0]) && w(a[l]) && e.length === b[e[0].toUpperCase()] && a.splice(l, 0, e[0].replace("M", "L").replace("m", "l")),
                    "string" === typeof a[l] && (e.length && c.push(e.slice(0)),
                    e.length = 0),
                    e.push(a[l]);
                c.push(e.slice(0));
                return c
            ...
            label: function(a, c, e, b, l, g, h, p, u) {
                var k = this, r = k.styledMode, z = k.g("button" !== u && "label"), m = z.text = k.text("", 0, 0, h).attr({
                    zIndex: 1
                }), y, P = {
                    width: 0,
                    height: 0,
                    x: 0,
                    y: 0
                }, n = P, t = 0, I = 3, G = 0, U, d, B, f, S, R = {}, x, W, T = /^url\((.*?)\)$/.test(b), D = r || T, q = function() {
                ...
                var Y = function() {
                    ...
                    D && (y || (z.box = y = k.symbols[b] || T ? k.symbol(b) : k.rect(),
                ...
                var H = function() {
                    ...
                    if (a !== m.x || c !== m.y)
                        m.attr("x", a),
                        m.hasBoxWidthChanged && (n = m.getBBox(!0),
                        Y()),
    ...
    Q(A, "parts/Html.js", [A["parts/Globals.js"], A["parts/Utilities.js"]], function(d, f) {
        ...
        J(D.prototype, {
            htmlCss: function(n) {
                ...
                n && "ellipsis" === n.textOverflow && (n.whiteSpace = "nowrap",
                n.overflow = "hidden");
            ...
            htmlUpdateTransform: function() {
                if (this.added) {
                    ...
                    if ("SPAN" === t.tagName) {
                        e = this.rotation;
                        var l = this.textWidth && x(this.textWidth), I = [e, v, t.innerHTML, this.textWidth, this.textAlign].join(), u;
                        ...
                        I !== this.cTT && (p = n.fontMetrics(t.style.fontSize, t).b,
        ...
        J(f.prototype, {
            ...
            html: function(n, t, d) {
                ...
                m.textSetter = function(e) {
                    e !== b.innerHTML && (delete this.bBox,
    ...
    Q(A, "parts/Tick.js", [A["parts/Globals.js"], A["parts/Utilities.js"]], function(d, f) {
        ...
        f = function() {
            ...
            d.prototype.handleOverflow = function(n) {
                ...
                var h = this.label, e = this.rotation, p = {
                    left: 0,
                    center: .5,
                    right: 1
                }[d.labelAlign || h.attr("align")], l = h.getBBox().width, I = d.getSlotWidth(this), u = I, y = 1, G, w = {};
                if (e || "justify" !== C(f.overflow, "justify"))
                    0 > e && m - p * l < v ? G = Math.round(m / Math.cos(e * D) - v) : 0 < e && m + p * l > g && (G = Math.round((b - m) / Math.cos(e * D)));
                else if (b = m + (1 - p) * l,
                m - p * l < v ? u = n.x + u * (1 - p) - v : b > g && (u = g - n.x + u * p,
                y = -1),
                u = Math.min(I, u),
                u < I && "center" === d.labelAlign && (n.x += y * (I - u - p * (I - Math.min(l, u)))),
                l > u || d.autoRotation && (h.styles || {}).width)
                    G = u;
                G && (this.shortenLabel ? this.shortenLabel() : (w.width = Math.floor(G) + "px",
            ...
            d.prototype.moveLabel = function(n, d) {
                var t = this
                  ...
                  , v = g.reversed
                  , h = g.chart.inverted;
                m && m.textStr === n ? (t.movedLabel = m,
                b = !0,
                delete t.label) : H(g.ticks, function(e) {
                    b || e.isNew || e === t || !e.label || e.label.textStr !== n || (t.movedLabel = e.label,
                    b = !0,
                    e.labelPos = t.movedLabel.xy,
                    delete e.label)
                });
                if (!b && (t.labelPos || m)) {
            ...
            d.prototype.renderGridLine = function(n, d, f) {
                var m = this.axis
                  ...
                  , y = b[I + "LineColor"];
                b = b[I + "LineDashStyle"];
                g || (m.chart.styledMode || (v.stroke = y,
                v["stroke-width"] = u,
                b && (v.dashstyle = b)),
                e || (v.zIndex = 1),
                n && (d = 0),
                this.gridLine = g = l.path().attr(v).addClass("highcharts-" + (e ? e + "-" : "") + "grid-line").add(m.gridGroup));
            ...
            d.prototype.renderMark = function(n, d, f) {
                ...
                b = b[h + "Color"];
                e && (m.opposite && (e[0] = -e[0]),
                l && (this.mark = p = g.path().addClass("highcharts-" + (v ? v + "-" : "") + "tick").add(m.axisGroup),
                m.chart.styledMode || p.attr({
                    stroke: b,
                    "stroke-width": u
                })),
                p[l ? "attr" : "animate"]({
            ...
            d.prototype.renderLabel = function(n, d, f, m) {
                ...
                var l = !0
                  , I = n.x;
                n = n.y;
                h && x(I) && (h.xy = n = this.getLabelPosition(I, n, h, g, e, b, m, p),
                this.isFirst && !this.isLast && !C(v.showFirstLabel, 1) || this.isLast && !this.isFirst && !C(v.showLastLabel, 1) ? l = !1 : !g || e.step || e.rotation || d || 0 === f || this.handleOverflow(n),
                p && m % p && (l = !1),
                l && x(n.y) ? (n.opacity = f,
                h[this.isNewLabel ? "attr" : "animate"](n),
                this.isNewLabel = !1) : (h.attr("y", -9999),
                this.isNewLabel = !0))
            }
            ;
        ...
        f = function() {
            ...
            f.prototype.makeTime = function(n, f, w, m, b, g) {
                if (this.useUTC) {
                    ...
                    v = (new this.Date(n,f,F(w, 1),F(m, 0),F(b, 0),F(g, 0))).getTime();
                return v
            }
            ;
            ...
            f.prototype.getTimeTicks = function(d, f, w, m) {
                var b = this
                  ...
                  , v = {};
                var h = new b.Date(f);
                var e = d.unitRange, p = d.count || 1, l;
                m = F(m, 1);
                if (E(f)) {
                    ...
                    e === C.week && (n = b.get("Day", h),
                    b.set("Date", h, b.get("Date", h) - n + m + (n < m ? -7 : 0)));
                    n = b.get("FullYear", h);
                    m = b.get("Month", h);
                    var u = b.get("Date", h)
                      , y = b.get("Hours", h);
                    ...
                    for (h = 1; f < w; )
                        g.push(f),
                        f = e === C.year ? b.makeTime(n + h * p, 0) : e === C.month ? b.makeTime(n, m + h * p) : !l || e !== C.day && e !== C.week ? l && e === C.hour && 1 < p ? b.makeTime(n, m, u, y + h * p) : f + e * p : b.makeTime(n, m, u + h * p * (e === C.day ? 1 : 7)),
                        h++;
                    g.push(f);
    ...
    Q(A, "parts/Axis.js", [A["parts/Color.js"], A["parts/Globals.js"], A["parts/Tick.js"], A["parts/Utilities.js"]], function(d, f, E, q) {
        ...
        q = function() {
            ...
            B.prototype.init = function(c, a) {
                ...
                a = e.options.events;
                -1 === c.axes.indexOf(e) && (k ? c.axes.splice(c.xAxis.length, 0, e) : c.axes.push(e),
                c[e.coll].push(e));
                e.series = e.series || [];
                        ...
                        if (e.visible || !a.options.chart.ignoreHiddenSeries) {
                            ...
                            if (c.isXAxis) {
                                ...
                                b.length) {
                                    ...
                                    var h = k.min;
                                    var p = k.max;
                                    g(h) || h instanceof Date || (b = b.filter(g),
                                    k = e.getXExtremes(b),
                                    h = k.min,
                                    p = k.max);
                                    b.length && (c.dataMin = Math.min(l(c.dataMin, h), h),
                                    c.dataMax = Math.max(l(c.dataMax, p), p))
                                }
                            } else if (e = e.applyExtremes(),
                            g(e.dataMin) && (h = e.dataMin,
                            c.dataMin = Math.min(l(c.dataMin, h), h)),
                            g(e.dataMax) && (p = e.dataMax,
                            c.dataMax = Math.max(l(c.dataMax, p), p)),
                            H(r) && (c.threshold = r),
            ...
            B.prototype.translate = function(c, a, k, e, b, l) {
                ...
                p -= h * (r.sector || r.len));
                a ? (c = (c * h + p - m) / z + e,
                b && (c = r.lin2val(c))) : (b && (c = r.val2lin(c)),
            ...
            B.prototype.getPlotLinePath = function(c) {
                ...
                var k = this, e = k.chart, b = k.left, h = k.top, p = c.old, m = c.value, u = c.translatedValue, v = c.lineWidth, d = c.force, y, O, f, I, G = p && e.oldChartHeight || e.chartHeight, t = p && e.oldChartWidth || e.chartWidth, B, w = k.transB;
                c = {
                    value: m,
                    lineWidth: v,
                    old: p,
                ...
                n(this, "getPlotLinePath", c, function(c) {
                    ...
                    g(u) ? k.horiz ? (O = h,
                    I = G - k.bottom,
                    y = f = a(y, b, b + k.width)) : (y = b,
                    f = t - k.right,
                    O = I = a(O, h, h + k.height)) : (B = !0,
                    d = !1);
            ...
            B.prototype.adjustForMinRange = function() {
                var c = this.options, a = this.min, k = this.max, e = this.logarithmic, b, g, h, p, u;
            ...
            B.prototype.nameToX = function(c) {
                ...
                if (-1 === e) {
                    ...
                    b = e;
                "undefined" !== typeof b && (this.names[b] = c.name,
                this.names.keys[c.name] = b);
                return b
            }
            ;
            ...
            B.prototype.setAxisTranslation = function(c) {
                ...
                if (d || m || b) {
                    var y = a.getClosest();
                    p ? (g = p.minPointOffset,
                    h = p.pointRangePadding) : a.series.forEach(function(c) {
            ...
            B.prototype.setTickInterval = function(c) {
                ...
                b && (a.positiveValuesOnly && !c && 0 >= Math.min(a.min, l(a.dataMin, a.min)) && D(10, 1, k),
                a.min = F(b.log2lin(a.min), 16),
                a.max = F(b.log2lin(a.max), 16));
                a.range && H(a.max) && (a.userMin = a.min = G = Math.max(a.dataMin, a.minFromRange()),
                a.userMax = t = a.max,
                a.range = null);
                n(a, "foundExtremes");
                a.beforePadding && a.beforePadding();
                a.adjustForMinRange();
                !(f || a.axisPointRange || a.stacking && a.stacking.usePercentage || m) && H(a.min) && H(a.max) && (k = a.max - a.min) && (!H(G) && v && (a.min -= k * v),
                !H(t) && u && (a.max += k * u));
                g(a.userMin) || (g(h.softMin) && h.softMin < a.min && (a.min = G = h.softMin),
                g(h.floor) && (a.min = Math.max(a.min, h.floor)));
                g(a.userMax) || (g(h.softMax) && h.softMax > a.max && (a.max = t = h.softMax),
                g(h.ceiling) && (a.max = Math.min(a.max, h.ceiling)));
                I && H(a.dataMin) && (O = O || 0,
                !H(G) && a.min < O && a.dataMin >= O ? a.min = a.options.minRange ? Math.min(O, a.max - a.minRange) : O : !H(t) && a.max > O && a.dataMax <= O && (a.max = a.options.minRange ? Math.max(O, a.min + a.minRange) : O));
            ...
            B.prototype.setTickPositions = function() {
                ...
                b && (b = b.apply(this, [this.min, this.max]))) && (this.tickPositions = e = b);
            ...
            B.prototype.adjustTickAmount = function() {
                var c = this.options, a = this.tickInterval, e = this.tickPositions, b = this.tickAmount, g = this.finalTickAmt, h = e && e.length, p = l(this.threshold, this.softThreshold ? 0 : null), m;
                if (this.hasData()) {
                    if (h < b) {
            ...
            B.prototype.setScale = function() {
                ...
                this.setAxisSize();
                (c = this.len !== this.oldAxisLength) || a || e || this.isLinked || this.forceRedraw || this.userMin !== this.oldUserMin || this.userMax !== this.oldUserMax || this.alignToOthers() ? (this.stacking && this.stacking.resetStacks(),
                this.forceRedraw = !1,
            ...
            B.prototype.zoom = function(c, a) {
                ...
                n(this, "zoom", c, function(a) {
                    var c = a.newMin
                      , k = a.newMax;
                    if (c !== e.min || k !== e.max)
                        e.allowZoomOutside || (H(b) && (c < p && (c = p),
                        c > m && (c = m)),
                        H(g) && (k < p && (k = p),
                        k > m && (k = m))),
            ...
            B.prototype.unsquish = function() {
                var c = this.options.labels, a = this.horiz, e = this.tickInterval, b = e, g = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / e), h, p = c.rotation, m = this.labelMetrics(), u, v = Number.MAX_VALUE, d, y = this.max - this.min, f = function(a) {
                    var c = a / (g || 1);
                    c = 1 < c ? Math.ceil(c) : 1;
            ...
            B.prototype.getSlotWidth = function(c) {
                var a, e = this.chart, b = this.horiz, l = this.options.labels, h = Math.max(this.tickPositions.length - (this.categories ? 0 : 1), 1), p = e.margin[3];
                if (c && g(c.slotWidth))
                    return c.slotWidth;
                if (b && l && 2 > (l.step || 0))
                    return l.rotation ? 0 : (this.staggerLines || 1) * this.len / h;
                if (!b) {
                    c = null === (a = null === l || void 0 === l ? void 0 : l.style) || void 0 === a ? void 0 : a.width;
                    if (void 0 !== c)
                        return parseInt(c, 10);
                    if (p)
                        return p - e.spacing[3]
                }
            ...
            B.prototype.renderUnsquish = function() {
                ...
                if (this.autoRotation)
                    ...
                    if (!y) {
                        ...
                        for (m = e.length; !h && m--; ) {
                            var G = e[m];
                            if (G = b[G].label)
                                G.styles && "ellipsis" === G.styles.textOverflow ? G.css({
                                    textOverflow: "clip"
                ...
                u.rotation && (n = f > .5 * c.chartHeight ? .33 * c.chartHeight : f,
                y || (I = "ellipsis"));
                ...
                e.forEach(function(a) {
                    var c = (a = b[a]) && a.label
                      ...
                      , k = {};
                    c && (c.attr(u),
                    a.shortenLabel ? a.shortenLabel() : n && !e && "nowrap" !== g.whiteSpace && (n < c.textPxLength || "SPAN" === c.element.tagName) ? (k.width = n + "px",
                    y || (k.textOverflow = c.specificTextOverflow || I),
                    c.css(k)) : c.styles && c.styles.width && !k.width && !e && c.css({
                        width: null
                    }),
            ...
            B.prototype.addTitle = function(c) {
                var a = this.chart.renderer, e = this.horiz, b = this.opposite, l = this.options.title, g, p = this.chart.styledMode;
                ...
                this.axisTitle = a.text(l.text, 0, 0, l.useHTML).attr({
                    zIndex: 7,
            ...
            B.prototype.getOffset = function() {
                var c = this, a = c.chart, e = a.renderer, b = c.options, g = c.tickPositions, h = c.ticks, m = c.horiz, u = c.side, v = a.inverted && !c.isZAxis ? [1, 0, 3, 2][u] : u, d, y = 0, f = 0, O = b.title, I = b.labels, G = 0, t = a.axisOffset;
                a = a.clipOffset;
                var B = [-1, 1, 1, -1][u]
                  , w = b.className
                  , S = c.axisParent;
                ...
                }).addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (w || "")).add(S),
                c.axisGroup = e.g("axis").attr({
                    zIndex: b.zIndex || 2
                }).addClass("highcharts-" + this.coll.toLowerCase() + " " + (w || "")).add(S),
                ...
                c.renderUnsquish(),
                c.reserveSpaceDefault = 0 === u || 2 === u || {
                    1: "left",
                    3: "right"
                }[u] === c.labelAlign,
                l(I.reserveSpace, "center" === c.labelAlign ? !0 : null, c.reserveSpaceDefault) && g.forEach(function(a) {
                    G = Math.max(h[a].getLabelSize(), G)
                }),
                c.staggerLines && (G *= c.staggerLines),
                c.labelOffset = G * (c.opposite ? -1 : 1)) : p(h, function(a, c) {
                    a.destroy();
                    delete h[c]
                });
                if (O && O.text && !1 !== O.enabled && (c.addTitle(d),
                d && !1 !== O.reserveSpace)) {
            ...
            B.prototype.renderTick = function(c, a) {
                ...
                if (!e || c >= this.min && c <= this.max)
                    b[c] || (b[c] = new E(this,c)),
                    l && b[c].isNew && b[c].render(a, !0, -1),
                    b[c].render(a)
            }
            ;
            B.prototype.render = function() {
                var c = this, a = c.chart, e = c.logarithmic, b = c.options, l = c.isLinked, h = c.tickPositions, m = c.axisTitle, u = c.ticks, d = c.minorTicks, v = c.alternateBands, y = b.stackLabels, I = b.alternateGridColor, O = c.tickmarkOffset, t = c.axisLine, B = c.showAxis, w = K(a.renderer.globalAnimation), S, R;
                ...
                if (c.hasData() || l)
                    ...
                    O && (0 === c.min || c.single) && (u[-1] || (u[-1] = new E(c,-1,null,!0)),
                    u[-1].render(-1))),
                    I && h.forEach(function(k, b) {
                        R = "undefined" !== typeof h[b + 1] ? h[b + 1] + O : c.max - O;
                        0 === b % 2 && k < c.max && R <= c.max + (a.polar ? -O : O) && (v[k] || (v[k] = new f.PlotLineOrBand(c)),
                        S = k + O,
                        v[k].options = {
                ...
                [u, d, v].forEach(function(c) {
                    var e, k = [], b = w.duration;
                    p(c, function(a, c) {
                        a.isActive || (a.render(c, !1, 0),
                        a.isActive = !1,
                        k.push(c))
                    });
                    G(function() {
                        for (e = k.length; e--; )
                            c[k[e]] && !c[k[e]].isActive && (c[k[e]].destroy(),
                            delete c[k[e]])
                ...
                t.isPlaced = !0,
                t[B ? "show" : "hide"](B));
                m && B && (b = c.getTitlePosition(),
                g(b.y) ? (m[m.isNew ? "attr" : "animate"](b),
            ...
            B.prototype.destroy = function(c) {
                var a = this, e = a.plotLinesAndBands, b;
                n(this, "destroy", {
                    keepEvents: c
                });
                c || u(a);
            ...
            B.prototype.drawCrosshair = function(c, a) {
                var e = this.crosshair, b = l(e.snap, !0), g, h = this.cross, p = this.chart;
        ...
        var E = f.addEvent
          ...
          , J = function() {
            ...
            d.prototype.normalizeTimeTickInterval = function(d, f) {
                ...
                f = x[x.length - 1];
                var C = K[f[0]], D = f[1], w;
                for (w = 0; w < x.length && !(f = x[w],
                C = K[f[0]],
                D = f[1],
                x[w + 1] && d <= (C * D[D.length - 1] + K[x[w + 1][0]]) / 2); w++)
                    ;
        ...
        var E = f.addEvent
          ...
          , J = function() {
            ...
            d.prototype.getLogTickPositions = function(d, f, H, C) {
                ...
                if (.5 <= d)
                    d = Math.round(d),
                    t = x.getLinearTickPositions(d, f, H);
                else if (.08 <= d) {
                    n = Math.floor(f);
                    var N, m;
                    ...
                    d = K("auto" === d ? null : d, this.minorAutoInterval, n.tickPixelInterval / (C ? 5 : 1) * (H - f) / ((C ? w / x.tickPositions.length : w) || 1)),
                    d = M(d, void 0, q(d)),
        ...
        f = function() {
            ...
            d.compose = function(d) {
                ...
                E(d, "init", function(d) {
                    ...
                    "logarithmic" !== d.userOptions.type ? this.logarithmic = void 0 : (f || (f = this.logarithmic = new J(this)),
        ...
        var q = E.arrayMax
          ...
          , D = function() {
            ...
            f.prototype.render = function() {
                ...
                h = m.log2lin(h),
                p = m.log2lin(p));
                t.chart.styledMode || (I ? (G.stroke = S || "#999999",
                G["stroke-width"] = C(b.width, 1),
                b.dashStyle && (G.dashstyle = b.dashStyle)) : l && (G.fill = S || "#e6ebf5",
                b.borderWidth && (G.stroke = b.borderColor,
                ...
                this.renderLabel(g, G, l, R)) : v && v.hide();
                return f
            }
            ;
                ...
                if (w && n) {
                    ...
                    for (d = 0; d < w.length; d += 2) {
                        ...
                        var h = w[d + 1]
                          , e = n[d]
                          , p = n[d + 1];
                        "M" !== f[0] && "L" !== f[0] || "M" !== h[0] && "L" !== h[0] || "M" !== e[0] && "L" !== e[0] || "M" !== p[0] && "L" !== p[0] || (b && e[1] === f[1] ? (e[1] += g,
                        p[1] += g) : b || e[2] !== f[2] || (e[2] += g,
                        p[2] += g),
        ...
        var N = d.doc
          , m = function() {
            ...
            b.prototype.getAnchor = function(b, d) {
                var g = this.chart, e = g.pointer, p = g.inverted, l = g.plotTop, m = g.plotLeft, u = 0, f = 0, v, n;
                b = w(b);
                ...
                u /= b.length,
                f /= b.length,
                b = [p ? g.plotWidth - f : u, this.shared && !p && 1 < b.length && d ? d.chartY - l : p ? g.plotHeight - u : f]);
            ...
            b.prototype.getDateFormat = function(b, d, h, e) {
                ...
                for (f in t) {
                    ...
                    if (m[f] && l.substr(m[f]) !== "01-01 00:00:00.000".substr(m[f]))
                        break;
                    "week" !== f && (u = f)
                }
                if (f)
                    var v = g.resolveDTLFormat(e[f]).main;
                return v
            }
            ;
            b.prototype.getLabel = function() {
                var b, m, h = this, e = this.chart.renderer, p = this.chart.styledMode, l = this.options, f = "tooltip" + (M(l.className) ? " " + l.className : ""), u = (null === (b = l.style) || void 0 === b ? void 0 : b.pointerEvents) || (!this.followPointer && l.stickOnContact ? "auto" : "none"), y;
                b = function() {
                    h.inContact = !0
                }
                ;
                ...
                if (!this.label) {
                    this.outside && (this.container = y = d.doc.createElement("div"),
                    ...
                    this.renderer = e = new d.Renderer(y,0,0,null === (m = this.chart.options.chart) || void 0 === m ? void 0 : m.style,void 0,void 0,e.styledMode));
            ...
            b.prototype.getPosition = function(b, d, h) {
                var e = this.chart, g = this.distance, l = {}, m = e.inverted && h.h || 0, u, f = this.outside, v = f ? N.documentElement.clientWidth - 2 * g : e.chartWidth, n = f ? Math.max(N.body.scrollHeight, N.documentElement.scrollHeight, N.body.offsetHeight, N.documentElement.offsetHeight, N.documentElement.clientHeight) : e.chartHeight, t = e.pointer.getChartPosition(), B = e.containerScaling, c = function(a) {
                ...
                }, r = k("y"), z = k("x"), w = !this.followPointer && D(h.ttBelow, !e.inverted === !!h.negative), x = function(e, b, k, h, p, r, d) {
                    var u = "y" === e ? a(g) : c(g)
                      , f = (k - h) / 2
                      , v = h < p - g
                      , y = p + g + h < b
                    ...
                    if (w && y)
                        ...
                        l[e] = Math.min(d - h, 0 > z - m ? z : z - m);
                    else if (y)
                        l[e] = Math.max(r, p + m + k > b ? p : p + m);
                    else
                        return !1
                    ...
                    !1 !== x.apply(0, r) ? !1 !== C.apply(0, z) || u || (q(!0),
                    T()) : u ? l.x = l.y = 0 : (q(!0),
                    T())
                };
            ...
            b.prototype.refresh = function(b, d) {
                ...
                if (e.enabled) {
                    ...
                    d = n[0];
                    var t = n[1];
                    !l || g.series && g.series.noSharedTooltip ? l = g.getLabelConfig() : (h.pointer.applyInactiveState(g),
                    ...
                    !1 === h ? this.hide() : (this.split ? this.renderSplit(h, w(b)) : (b = this.getLabel(),
                    e.style.width && !v || b.css({
                        width: this.chart.spacingBox.width + "px"
                    }),
                    b.attr({
                        text: h && h.join ? h.join("") : h
                    }),
                    b.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + D(g.colorIndex, u.colorIndex)),
                    v || b.attr({
            ...
            b.prototype.renderSplit = function(b, m) {
                function g(a, c, e, b, k) {
                    void 0 === k && (k = !0);
                    e ? (c = C ? 0 : F,
                    a = E(a - b / 2, x.left, x.right - b)) : (c -= T,
                    a = k ? a - b - r : a + r,
                    a = E(a, k ? a : x.left, x.right));
                    return {
                        x: a,
                        y: c
                    }
                ...
                b = b.slice(0, m.length + 1).reduce(function(c, b, l) {
                    if (!1 !== b && "" !== b) {
                        ...
                        k || (p.fill = z.backgroundColor,
                        p["stroke-width"] = z.borderWidth),
                        p = t.label("", 0, 0, z[y ? "headerShape" : "shape"] || "callout", void 0, void 0, z.useHTML).addClass((y ? "highcharts-tooltip-header " : "") + "highcharts-tooltip-box " + G).attr(p).add(q));
                        p.isActive = !0;
                        p.attr({
                            text: b
                        });
            ...
            b.prototype.drawTracker = function() {
                if (this.followPointer || !this.options.stickOnContact)
                    ...
                    if (d && h) {
                        ...
                        this.tracker ? this.tracker.attr(e) : (this.tracker = d.renderer.rect(e).addClass("highcharts-tracker").add(d),
        ...
        f = function() {
            ...
            f.prototype.drop = function(b) {
                ...
                if (this.selectionMarker) {
                    var g = {
                        ...
                        xAxis: [],
                        yAxis: []
                    }, d = this.selectionMarker, m = d.attr ? d.attr("x") : d.x, f = d.attr ? d.attr("y") : d.y, v = d.attr ? d.attr("width") : d.width, n = d.attr ? d.attr("height") : d.height, B;
            ...
            f.prototype.getHoverData = function(b, e, g, l, d, m) {
                ...
                f.forEach(function(e) {
                    ...
                    D(c) && (e.chart.isBoosting && (c = e.getPoint(c)),
                    p.push(c))
                })) : p.push(h));
                u = {
                    hoverPoint: h
            ...
            f.prototype.init = function(b, e) {
                ...
                this.pinchDown = [];
                this.lastValidTouch = {};
                E && (b.tooltip = new E(b,e.tooltip),
                this.followTouchMove = t(e.tooltip.followTouchMove, !0));
                this.setDOMEvents()
            }
            ;
            ...
            f.prototype.onContainerMouseLeave = function(g) {
                ...
                g = this.normalize(g);
                e && (g.relatedTarget || g.toElement) && (e.pointer.reset(),
            ...
            f.prototype.pinchTranslateDirection = function(b, e, g, l, d, m, f, v) {
                var h = this.chart, p = b ? "x" : "y", u = b ? "X" : "Y", c = "chart" + u, a = b ? "width" : "height", k = h["plot" + (b ? "Left" : "Top")], r, z, y = v || 1, n = h.inverted, G = h.bounds[b ? "h" : "v"], t = 1 === e.length, w = e[0][c], I = g[0][c], x = !t && e[1][c], O = !t && g[1][c];
                g = function() {
            ...
            f.prototype.reset = function(b, e) {
                ...
                if (b)
                    m && f && N(f).length && (m.refresh(f),
                    m.shared && h ? h.forEach(function(e) {
                        e.setState(e.state, !0);
                        e.series.isCartesian && (e.series.xAxis.crosshair && e.series.xAxis.drawCrosshair(null, e),
            ...
            f.prototype.runPointActions = function(g, e) {
                ...
                if (f && (f !== h.hoverPoint || l && l.isHidden)) {
                    ...
                    e && l && !l.isHidden && (f = l.getAnchor([{}], g),
                    l.updatePosition({
                        plotX: f[0],
                        plotY: f[1]
                    }));
                this.unDocMouseMove || (this.unDocMouseMove = M(h.container.ownerDocument, "mousemove", function(e) {
                    ...
                    if (l)
                        l.pointer.onDocumentMouseMove(e)
                }));
                h.axes.forEach(function(e) {
                    var b = t((e.crosshair || {}).snap, !0), l;
            ...
            f.prototype.scaleGroups = function(b, e) {
                ...
                g.series.forEach(function(d) {
                    l = b || d.getPlotBox();
                    d.xAxis && d.xAxis.zoomEnabled && d.group && (d.group.attr(l),
                    d.markerGroup && (d.markerGroup.attr(l),
                    d.markerGroup.clip(e ? g.clipRect : null)),
            ...
            f.prototype.setDOMEvents = function() {
                ...
                d.hasTouch && (M(b, "touchstart", this.onContainerTouchStart.bind(this)),
                M(b, "touchmove", this.onContainerTouchMove.bind(this)),
                d.unbindDocumentTouchEnd || (d.unbindDocumentTouchEnd = M(e, "touchend", this.onDocumentTouchEnd.bind(this))))
            }
            ;
    ...
    Q(A, "parts/MSPointer.js", [A["parts/Globals.js"], A["parts/Pointer.js"], A["parts/Utilities.js"]], function(d, f, E) {
        ...
        var K = this && this.__extends || function() {
            ...
            return function(f, m) {
                ...
                d(f, m);
                f.prototype = null === m ? Object.create(m) : (b.prototype = m.prototype,
                new b)
            }
        }()
          , J = E.addEvent
        ...
        var m = d.isFirefox
          ...
          , v = function() {
            ...
            g.prototype.setOptions = function(e) {
                var b = D(e.padding, 8);
                this.options = e;
                this.chart.styledMode || (this.itemStyle = e.itemStyle,
                this.itemHiddenStyle = C(this.itemStyle, e.itemHiddenStyle));
            ...
            g.prototype.colorizeItem = function(e, b) {
                ...
                if (!this.chart.styledMode) {
                    ...
                    m && (v && m.isMarker && (n = e.pointAttribs(),
                    b || (n.stroke = n.fill = f)),
                    m.attr(n))
                }
            ...
            g.prototype.renderItem = function(b) {
                ...
                this.baseline || (this.fontMetrics = g.fontMetrics(e.styledMode ? 12 : f.fontSize, c),
            ...
            g.prototype.layoutItem = function(b) {
                ...
                d && this.itemX - g + e > n && (this.itemX = g,
                ...
                d ? this.itemX += e : (this.itemY += f + h + m,
            ...
            g.prototype.proximatePositions = function() {
                ...
                this.allItems.forEach(function(e) {
                    ...
                    if (e.yAxis && e.points) {
                        ...
                        e.visible ? (h = h ? h.plotY : e.yAxis.height,
                        h += m - .3 * d) : h = m + e.yAxis.height;
                        g.push({
                            target: h,
                            size: d,
                            item: e
            ...
            g.prototype.handleOverflow = function(b) {
                ...
                var v = h.maxHeight, n, w = this.clipRect, c = h.navigation, a = D(c.animation, !0), k = c.arrowSize || 12, r = this.nav, z = this.pages, t, x = this.allItems, q = function(a) {
                ...
                v && (m = Math.min(m, v));
                z.length = 0;
                b > m && !1 !== c.enabled ? (this.clipHeight = n = Math.max(m - 20 - this.titleHeight - f, 0),
                ...
                x.forEach(function(a, c) {
                    var b = a._legendItemPos[1]
                      ...
                      , k = z.length;
                    if (!k || b - z[k - 1] > n && (t || b) !== z[k - 1])
                        z.push(t || b),
                        k++;
                    a.pageIx = k - 1;
                    t && (x[c - 1].pageIx = k - 1);
                    c === x.length - 1 && b + e - z[k - 1] > n && b !== t && (z.push(b),
                    a.pageIx = k);
                    b !== t && (t = b)
                }),
                w || (w = e.clipRect = d.clipRect(0, f, 9999, 0),
                e.contentGroup.clip(w)),
                q(n),
                r || (this.nav = r = d.g().attr({
                    zIndex: 1
                }).add(this.group),
    ...
    Q(A, "parts/Chart.js", [A["parts/Globals.js"], A["parts/Legend.js"], A["parts/MSPointer.js"], A["parts/Pointer.js"], A["parts/Time.js"], A["parts/Utilities.js"]], function(d, f, E, q, M, K) {
        ...
        N(aa.prototype, {
            ...
            getArgs: function() {
                var a = [].slice.call(arguments);
                if (l(a[0]) || a[0].nodeName)
                    this.renderTo = a.shift();
                this.init(a[0], a[1])
            },
            init: function(a, c) {
                var e, k = a.series, g = a.plotOptions || {};
                b(this, "init", {
                    args: arguments
                }, function() {
                    a.series = null;
            ...
            redraw: function(a) {
                ...
                k.forEach(function(a) {
                    ...
                    h = !0) : l && (l.labelFormatter || l.labelFormat) && (h = !0));
            ...
            temporaryDisplay: function(a) {
                ...
                if (a)
                    for (; c && c.style; )
                        c.hcOrigStyle && (C(c, c.hcOrigStyle),
                        delete c.hcOrigStyle),
                        c.hcOrigDetached && (z.body.removeChild(c),
                        c.hcOrigDetached = !1),
                        c = c.parentNode;
                else
                    for (; c && c.style; ) {
                        z.body.contains(c) || c.parentNode || (c.hcOrigDetached = !0,
            ...
            setChartSize: function(a) {
                var c = this.inverted, e = this.renderer, k = this.chartWidth, g = this.chartHeight, d = this.options.chart, l = this.spacing, h = this.clipOffset, m, f, r, u;
            ...
            drawChartBox: function() {
                ...
                g || (this.chartBackground = g = c.rect().addClass("highcharts-background").add(),
                P = "attr");
                if (h)
                    var G = p = g.strokeWidth();
                else {
                    G = a.borderWidth || 0;
                    p = G + (a.shadow ? 8 : 0);
                    f = {
                ...
                u && (m ? (u !== m.attr("href") && m.attr("href", u),
                m.animate(w)) : this.plotBGImage = c.image(u, v, z, n, y).add()));
                t ? t.animate({
                    width: B.width,
                    height: B.height
                ...
                P = "animate";
                l || (P = "attr",
                this.plotBorder = l = c.rect().addClass("highcharts-plot-border").attr({
                    zIndex: 1
                }).add());
                h || l.attr({
            ...
            propFromSeries: function() {
                var a = this, c = a.options.chart, b, e = a.options.series, k, g;
            ...
            linkSeries: function() {
                ...
                c.forEach(function(c) {
                    ...
                    l(b) && (b = ":previous" === b ? a.series[c.index - 1] : a.get(b)) && b.linkedParent !== c && (b.linkedSeries.push(c),
                    c.linkedParent = b,
            ...
            destroy: function() {
                var a = this, c = a.axes, e = a.series, k = a.container, g, l = k && k.parentNode;
                b(a, "destroy");
    ...
    Q(A, "parts/ScrollablePlotArea.js", [A["parts/Globals.js"], A["parts/Utilities.js"]], function(d, f) {
            ...
            if (!this.renderer.forExport) {
                if (x) {
                    if (this.scrollablePixelsX = x = Math.max(0, x - this.chartWidth)) {
                        this.plotWidth += x;
                        this.inverted ? (this.clipBox.height += x,
                        this.plotBox.height += x) : (this.clipBox.width += x,
                    ...
                    q && (this.scrollablePixelsY = x = Math.max(0, q - this.chartHeight)) && (this.plotHeight += x,
                    this.inverted ? (this.clipBox.width += x,
                    this.plotBox.width += x) : (this.clipBox.height += x,
        ...
        f.prototype.applyFixed = function() {
            var f, L, x = !this.fixedDiv, F = this.options.chart.scrollablePlotArea;
            ...
            this.fixedRenderer = L = new d.Renderer(this.fixedDiv,this.chartWidth,this.chartHeight,null === (f = this.options.chart) || void 0 === f ? void 0 : f.style),
            ...
            E(this, "afterLayOutTitles", this.moveFixedElements)) : this.fixedRenderer.setSize(this.chartWidth, this.chartHeight);
            ...
            x && (F.scrollPositionX && (this.scrollingContainer.scrollLeft = this.scrollablePixelsX * F.scrollPositionX),
        ...
        var f = d.addEvent
          ...
          , J = function() {
            ...
            d.prototype.buildStacks = function() {
                var d = this.axis, f = d.series, H = K(d.options.reversedStacks, !0), C = f.length, D;
                if (!d.isXAxis) {
            ...
            d.prototype.resetStacks = function() {
                ...
                d.axis.isXAxis || A(f, function(f) {
                    A(f, function(q, x) {
                        q.touched < d.stacksTouched ? (q.destroy(),
                        delete f[x]) : (q.total = null,
                        q.cumulative = null)
                    })
                })
            }
    ...
    Q(A, "mixins/legend-symbol.js", [A["parts/Globals.js"], A["parts/Utilities.js"]], function(d, f) {
        ...
        d.LegendSymbolMixin = {
            ...
            drawLineMarker: function(d) {
                ...
                A && !1 !== A.enabled && L && (f = Math.min(q(A.radius, F), F),
                0 === this.symbol.indexOf("url") && (A = E(A, {
                    width: x,
                    height: x
                }),
                f = 0),
                this.legendSymbol = A = H.symbol(this.symbol, L / 2 - f, d - f, 2 * f, 2 * f, A).addClass("highcharts-point").add(C),
                A.isMarker = !0)
            }
        };
    ...
    Q(A, "parts/Point.js", [A["parts/Globals.js"], A["parts/Utilities.js"]], function(d, f) {
        ...
        f = function() {
            ...
            d.prototype.destroy = function() {
                ...
                var h = f.hoverPoints, e = A(b.series.chart.renderer.globalAnimation), p;
                b.legendItem && f.legend.destroyItem(b);
                h && (b.setState(),
                M(h, b),
                h.length || (f.hoverPoints = null));
                if (b === f.hoverPoint)
                    b.onMouseOut();
            ...
            d.prototype.getNestedProperty = function(d) {
                if (d)
                    return 0 === d.indexOf("custom.") ? x(d, this.options) : this[d]
            }
            ;
            ...
            d.prototype.optionsToObject = function(f) {
                ...
                if (H(f) || null === f)
                    ...
                    for (!m && f.length > e && (g = typeof f[0],
                    "string" === g ? b.name = f[0] : "number" === g && (b.x = f[0]),
                    p++); l < e; )
                        m && "undefined" === typeof f[p] || (0 < h[l].indexOf(".") ? d.prototype.setNestedProperty(b, f[p], h[l]) : b[h[l]] = f[p]),
                        p++,
                        l++;
                else
                    "object" === typeof f && (b = f,
                    f.dataLabels && (g._hasPointLabels = !0),
                    f.marker && (g._hasPointMarkers = !0));
                return b
            }
            ;
            d.prototype.resolveColor = function() {
                ...
                d.options.colorByPoint ? (g || (b = d.options.colors || d.chart.options.colors,
                this.color = this.color || b[d.colorCounter],
                b = b.length),
                g = d.colorCounter,
                d.colorCounter++,
                d.colorCounter === b && (d.colorCounter = 0)) : g = d.colorIndex;
    ...
    Q(A, "parts/Series.js", [A["mixins/legend-symbol.js"], A["parts/Globals.js"], A["parts/Point.js"], A["parts/Utilities.js"]], function(d, f, A, q) {
        ...
        f.Series = I("line", null, {
            ...
            bindAxes: function() {
                var a = this, c = a.options, b = a.chart, e;
                t(this, "bindAxes", null, function() {
                    (a.axisTypes || []).forEach(function(d) {
                        b[d].forEach(function(b) {
                            e = b.options;
                            if (c[d] === e.index || "undefined" !== typeof c[d] && c[d] === e.id || "undefined" === typeof c[d] && 0 === e.index)
                                a.insert(b.series),
                                a[d] = b,
                                b.isDirty = !0
                        });
            ...
            autoIncrement: function() {
                var a = this.options, c = this.xIncrement, b, e = a.pointIntervalUnit, d = this.chart.time;
                c = p(c, a.pointStart, 0);
                this.pointInterval = b = p(this.pointInterval, a.pointInterval, 1);
                e && (a = new d.Date(c),
                "day" === e ? d.set("Date", a, d.get("Date", a) + b) : "month" === e ? d.set("Month", a, d.get("Month", a) + b) : "year" === e && d.set("FullYear", a, d.get("FullYear", a) + b),
                b = a.getTime() - c);
                this.xIncrement = c + b;
                return c
            },
            ...
            findPointIndex: function(a, c) {
                var b = a.id, e = a.x, d = this.points, k, l = this.options.dataSorting;
                if (b)
                    var f = this.chart.get(b);
            ...
            updateData: function(a, c) {
                var b = this.options, e = b.dataSorting, d = this.points, k = [], l, f, h, m = this.requireSorting, u = a.length === d.length, p = !0;
                ...
                a.forEach(function(a, c) {
                    ...
                    var r = f.x;
                    if (f.id || g(r)) {
                        if (r = this.findPointIndex(f, h),
                        -1 === r || "undefined" === typeof r ? k.push(a) : d[r] && a !== b.data[r] ? (d[r].update(a, !1, null, !1),
                        d[r].touched = !0,
                        m && (h = r + 1)) : d[r] && (d[r].touched = !0),
                ...
                if (l)
                    ...
                    !u || e && e.enabled ? p = !1 : (a.forEach(function(a, c) {
                ...
                null === this.xIncrement && this.xData && this.xData.length && (this.xIncrement = J(this.xData),
                this.autoIncrement());
                return !0
            },
            setData: function(a, c, b, e) {
                var d = this, k = d.points, l = k && k.length || 0, f, h = d.options, r = d.chart, u = h.dataSorting, n = null, z = d.xAxis;
                n = h.turboThreshold;
                var y = this.xData, w = this.yData, t = (f = d.pointArrayMap) && f.length, B = h.keys, G = 0, q = 1, x;
                a = a || [];
                f = a.length;
                c = p(c, !0);
                ...
                if (!x) {
                    ...
                    if (n && f > n)
                        if (n = d.getFirstValidPoint(a),
                        g(n))
                            for (b = 0; b < f; b++)
                                y[b] = this.autoIncrement(),
                                w[b] = a[b];
                        else if (m(n))
                            if (t)
                                for (b = 0; b < f; b++)
            ...
            getProcessedData: function(a) {
                ...
                for (l = c.length || 1; --l; )
                    if (e = f ? a(c[l]) - a(c[l - 1]) : c[l] - c[l - 1],
                    0 < e && ("undefined" === typeof y || e < y))
                        var y = e;
                    else
                        0 > e && u && (D(15, !1, this.chart),
                        u = !1);
                return {
                    xData: c,
                    yData: b,
            ...
            generatePoints: function() {
                var a = this.options, c = a.data, b = this.data, e, d = this.processedXData, g = this.processedYData, f = this.pointClass, l = d.length, h = this.cropStart || 0, m = this.hasGroupedData;
                a = a.keys;
                var p = [], n;
                b || m || (b = [],
                b.length = c.length,
                ...
                for (n = 0; n < l; n++) {
                    ...
                    if (m) {
                        ...
                        w(y, y.dataGroup.options),
                        delete y.dataLabels)
                    } else
                        (y = b[v]) || "undefined" === typeof c[v] || (b[v] = y = (new f).init(this, c[v], d[n]));
                    y && (y.index = v,
                    p[n] = y)
                }
                this.options.keys = a;
            ...
            getExtremes: function(a, c) {
                var b = this.xAxis
                  ...
                  , f = 0;
                var h = 0;
                var u = this.requireSorting ? this.cropShoulder : 0, n = e ? e.positiveValuesOnly : !1, p;
            ...
            translate: function() {
                ...
                this.generatePoints();
                var a = this.options, c = a.stacking, b = this.xAxis, e = b.categories, d = this.enabledDataSorting, l = this.yAxis, f = this.points, h = f.length, u = !!this.modifyValue, n, v = this.pointPlacementToXValue(), y = !!v, w = a.threshold, B = a.startFromThreshold ? w : 0, G, q = this.zoneAxis || "y", I = Number.MAX_VALUE;
                for (n = 0; n < h; n++) {
                    var C = f[n]
                      , D = C.x
                      , R = C.y
            ...
            setClip: function(a) {
                var c = this.chart
                  ...
                  , m = c[f + "m"];
                a && (l.width = 0,
                d && (l.x = c.plotHeight + (!1 !== b.clip ? 0 : c.plotTop)));
                h ? c.hasLoaded || h.attr(l) : (a && (c[f + "m"] = m = e.clipRect(d ? c.plotSizeX + 99 : -99, d ? -c.plotLeft : -c.plotTop, 99, d ? c.chartWidth : c.chartHeight)),
                c[f] = h = e.clipRect(l),
                h.count = {
                    length: 0
                });
                a && !h.count[this.index] && (h.count[this.index] = !0,
                h.count.length += 1);
                if (!1 !== b.clip || a)
                    this.group.clip(a || g ? h : c.clipRect),
                    this.markerGroup.clip(m),
                    this.sharedClipKey = f;
                a || (h.count[this.index] && (delete h.count[this.index],
                --h.count.length),
                0 === h.count.length && f && c[f] && (g || (c[f] = c[f].destroy()),
            ...
            drawPoints: function() {
                var a = this.points, c = this.chart, b, e, d = this.options.marker, g = this[this.specialGroup] || this.markerGroup, f = this.xAxis, l = p(d.enabled, !f || f.isRadial ? !0 : null, this.closestPointRangePx >= d.enabledThreshold * d.radius);
                if (!1 !== d.enabled || this._hasPointMarkers)
                    for (b = 0; b < a.length; b++) {
                        ...
                        if ((l && "undefined" === typeof u.enabled || u.enabled) && !h.isNull && !1 !== h.visible) {
                            ...
                            var w = !1 !== h.isInside;
                            e ? e[w ? "show" : "hide"](w).animate(y) : w && (0 < y.width || h.hasImage) && (h.graphic = e = c.renderer.symbol(v, y.x, y.y, y.width, y.height, n ? u : d).add(g),
                            this.enabledDataSorting && c.hasRendered && (e.attr({
                                x: h.startXPos
                            }),
                            m = "animate"));
                            e && "animate" === m && e[w ? "show" : "hide"](w).animate(y);
                            if (e && !c.styledMode)
                                e[m](this.pointAttribs(h, h.selected && "select"));
                            e && e.addClass(h.getClassName(), !0)
                        } else
                            e && (h.graphic = e.destroy())
                    }
            },
            ...
            destroy: function(a) {
                var b = this, d = b.chart, g = /AppleWebKit\/533/.test(c.navigator.userAgent), f, l, h = b.data || [], m, u;
                t(b, "destroy");
                this.removeEvents(a);
                (b.axisTypes || []).forEach(function(a) {
                    (u = b[a]) && u.series && (C(u.series, b),
                    u.isDirty = u.forceRedraw = !0)
                });
                ...
                e(b, function(a, c) {
                    a instanceof B && !a.survive && (f = g && "group" === c ? "hide" : "destroy",
                    a[f]())
                });
            ...
            getGraphPath: function(a, c, b) {
                var e = this, d = e.options, g = d.step, k, f = [], l = [], h;
                a = a || e.points;
                ...
                a.forEach(function(k, m) {
                    ...
                    k.isNull && !H(c) && 0 < m ? h = !d.connectNulls : k.isNull && !c ? h = !0 : (0 === m || h ? m = [["M", k.plotX, k.plotY]] : e.getPointSpline ? m = [e.getPointSpline(a, k, m)] : g ? (m = 1 === g ? [["L", n.plotX, r]] : 2 === g ? [["L", (n.plotX + u) / 2, n.plotY], ["L", (n.plotX + u) / 2, r]] : [["L", u, n.plotY]],
                    m.push(["L", u, r])) : m = [["L", u, r]],
                    l.push(k.x),
                    g && (l.push(k.x),
                    2 === g && l.push(k.x)),
                    f.push.apply(f, m),
            ...
            drawGraph: function() {
                ...
                d.forEach(function(d, g) {
                    var k = d[0]
                      , f = a[k]
                      , l = f ? "animate" : "attr";
                    f ? (f.endX = a.preventGraphAnimation ? null : b.xMap,
                    f.animate({
                        d: b
                    ...
                    d[3] ? k.dashstyle = d[3] : "square" !== c.linecap && (k["stroke-linecap"] = k["stroke-linejoin"] = "round"),
            ...
            applyZones: function() {
                var a = this, c = this.chart, b = c.renderer, e = this.zones, d, g, f = this.clips || [], l, h = this.graph, m = this.area, u = Math.max(c.chartWidth, c.chartHeight), n = this[(this.zoneAxis || "y") + "Axis"], v = c.inverted, y, w, t, B = !1, G, q;
            ...
            invertGroups: function(a) {
                ...
                var b = this
                  , e = b.chart;
                b.xAxis && (b.eventsToUnbind.push(E(e, "resize", c)),
                c(),
                b.invertGroups = c)
            },
            ...
            searchKDTree: function(a, c, b) {
                function e(a, c, b, l) {
                    ...
                    c[p] && (p = e(a, c[p], b + 1, l),
                    u = p[f] < u[f] ? p : h);
                    c[n] && Math.sqrt(m * m) < u[f] && (a = e(a, c[n], b + 1, l),
                    u = a[f] < u[f] ? a : u);
                    return u
                }
                var d = this
    ...
    Q(A, "parts/Stacking.js", [A["parts/Axis.js"], A["parts/Globals.js"], A["parts/StackingAxis.js"], A["parts/Utilities.js"]], function(d, f, A, q) {
        ...
        var F = f.Series
          , H = function() {
            ...
            d.prototype.render = function(d) {
                ...
                f.styledMode || (t.fill = n.backgroundColor,
            ...
            d.prototype.setOffset = function(d, f, n, t, q) {
                ...
                f && m && (q = f.getBBox(),
                t = f.padding,
                g = "left" === g ? b.inverted ? -t : t : "right" === g ? q.width : b.inverted && "center" === g ? q.width / 2 : b.inverted ? n ? q.width + t : -t : q.width / 2,
                ...
                b.isInsidePlot(f.alignAttr.x + g - this.alignOptions.x, f.alignAttr.y + n - this.alignOptions.y) ? f.show() : (f.alignAttr.y = -9999,
                d = !1),
        ...
        F.prototype.setStackedPoints = function() {
            if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                var d = this.processedXData
                  ...
                  , b = t.stack;
                t = t.stacking;
                var g = this.stackKey, v = "-" + g, h = this.negStacks, e = this.yAxis, p = e.stacking.stacks, l = e.stacking.oldStacks, I, u;
                ...
                for (u = 0; u < n; u++) {
                    ...
                    p[B] || (p[B] = {});
                    p[B][y] || (l[B] && l[B][y] ? (p[B][y] = l[B][y],
                    p[B][y].total = null) : p[B][y] = new H(e,e.options.stackLabels,I,y,b));
                    B = p[B][y];
                    null !== G ? (B.points[R] = B.points[this.index] = [x(B.cumulative, m)],
                    K(B.cumulative) || (B.base = R),
                    B.touched = e.stacking.stacksTouched,
                    0 < S.index && !1 === this.singleStacks && (B.points[R][0] = B.points[this.index + "," + y + ",0"][0])) : B.points[R] = B.points[this.index] = null;
                    "percent" === t ? (I = I ? g : v,
                    h && p[I] && p[I][y] ? (I = p[I][y],
                    B.total = I.total = Math.max(I.total, B.total) + Math.abs(G) || 0) : B.total = E(B.total + (Math.abs(G) || 0))) : B.total = E(B.total + (G || 0));
                    B.cumulative = x(B.cumulative, m) + (G || 0);
                    null !== G && (B.points[R].push(B.cumulative),
                    w[u] = B.cumulative)
                }
        ...
        F.prototype.modifyStacks = function() {
            var d = this, f = d.stackKey, w = d.yAxis.stacking.stacks, n = d.processedXData, t, q = d.options.stacking;
    ...
    Q(A, "parts/Dynamics.js", [A["parts/Globals.js"], A["parts/Point.js"], A["parts/Time.js"], A["parts/Utilities.js"]], function(d, f, A, q) {
        ...
        d.cleanRecursively = function(e, g) {
            ...
            b(e, function(b, l) {
                if (t(e[l], !0) && !e.nodeType && g[l])
                    b = d.cleanRecursively(e[l], g[l]),
                    Object.keys(b).length && (f[l] = b);
                else if (t(e[l]) || e[l] !== g[l])
                    f[l] = e[l]
            });
            return f
        }
        ...
        C(q.prototype, {
            ...
            update: function(f, l, h, p) {
                var u = this, y = {
                    ...
                    subtitle: "setSubtitle",
                    caption: "setCaption"
                }, c, a, k, r = f.isResponsiveOptions, t = [];
                D(u, "update", {
                    options: f
                });
                ...
                b(f, function(c, b) {
                    if (u[b] && "function" === typeof u[b].update)
                        u[b].update(c, !1);
                    else if ("function" === typeof u[y[b]])
                        u[y[b]](c);
                ...
                this.collectionsWithUpdate.forEach(function(a) {
                    if (f[a]) {
                        ...
                        e(f[a]).forEach(function(b, e) {
                            (e = x(b.id) && u.get(b.id) || u[a][c ? c[e] : e]) && e.coll === a && (e.update(b, !1),
                            h && (e.touched = !0));
        ...
        C(f.prototype, {
            update: function(b, e, d, f) {
                function l() {
                    ...
                    f = null === h.y ? !f : f;
                    a && f && (h.graphic = a.destroy(),
                    delete h.hasDummyGraphic);
                    t(b, !0) && (a && a.element && b && b.marker && "undefined" !== typeof b.marker.symbol && (h.graphic = a.destroy()),
                ...
                var h = this, c = h.series, a = h.graphic, k, m = c.chart, u = c.options;
                e = g(e, !0);
        ...
        C(l.prototype, {
            addPoint: function(b, e, d, f, l) {
                ...
                k && p.name && (k[v] = p.name);
                m.splice(y, 0, b);
                n && (this.data.splice(y, 0, null),
                this.processData());
                "point" === h.legendType && this.generatePoints();
                d && (c[0] && c[0].remove ? c[0].remove(!1) : (c.shift(),
            ...
            update: function(b, e) {
                ...
                var f = this, l = f.chart, h = f.userOptions, n = f.initialType || f.type, c = b.type || h.type || l.options.chart.type, a = !(this.hasDerivedData || b.dataGrouping || c && c !== this.type || "undefined" !== typeof b.pointStart || b.pointInterval || b.pointIntervalUnit || b.keys), k = I[n].prototype, p, u = ["group", "markerGroup", "dataLabelsGroup", "transformGroup"], v = ["eventOptions", "navigatorSeries", "baseSeries"], y = f.finishedAnimating && {
                    animation: !1
                }, t = {};
                a && (v.push("data", "isDirtyData", "points", "processedXData", "processedYData", "xIncrement", "_hasPointMarkers", "_hasPointLabels", "mapMap", "mapData", "minY", "maxY", "minX", "maxX"),
                !1 !== b.visible && v.push("area", "graph"),
                f.parallelArrays.forEach(function(a) {
                    v.push(a + "Data")
                }),
                b.data && (b.dataSorting && C(f.options.dataSorting, b.dataSorting),
                ...
                if (a && this.points) {
                    var w = f.options;
                    !1 === w.visible ? (t.graphic = 1,
                    t.dataLabel = 1) : f._hasPointLabels || (c = w.marker,
                    k = w.dataLabels,
    ...
    Q(A, "parts/AreaSeries.js", [A["parts/Globals.js"], A["parts/Color.js"], A["mixins/legend-symbol.js"], A["parts/Utilities.js"]], function(d, f, A, q) {
        ...
        f("area", "line", {
            ...
            getStackPoints: function(d) {
                var f = [], q = [], x = this.xAxis, D = this.yAxis, w = D.stacking.stacks[this.stackKey], n = {}, t = this.index, A = D.series, m = A.length, b = J(D.options.reversedStacks, !0) ? 1 : -1, g;
                d = d || this.points;
                if (this.options.stacking) {
                    for (g = 0; g < d.length; g++)
                        d[g].leftNull = d[g].rightNull = void 0,
                        n[d[g].x] = d[g];
                    K(w, function(b, e) {
            ...
            drawGraph: function() {
                ...
                C.forEach(function(x) {
                    var w = x[0]
                      ...
                      , t = n ? "animate" : "attr"
                      , C = {};
                    n ? (n.endX = d.preventGraphAnimation ? null : f.xMap,
                    n.animate({
                        d: f
                    })) : (C.zIndex = 0,
        ...
        d("spline", "line", {}, {
            getPointSpline: function(d, q, A) {
                ...
                if (L && !L.isNull && !1 !== L.doCurve && !q.isCliff && A && !A.isNull && !1 !== A.doCurve && !q.isCliff) {
                    ...
                    C += F;
                    D += F;
                    C > d && C > J ? (C = Math.max(d, J),
                    D = 2 * J - C) : C < d && C < J && (C = Math.min(d, J),
                    D = 2 * J - C);
                    D > A && D > J ? (D = Math.max(A, J),
                    C = 2 * J - D) : D < A && D < J && (D = Math.min(A, J),
                    C = 2 * J - D);
                    q.rightContX = x;
                    q.rightContY = D
                }
    ...
    Q(A, "parts/ColumnSeries.js", [A["parts/Globals.js"], A["parts/Color.js"], A["mixins/legend-symbol.js"], A["parts/Utilities.js"]], function(d, f, A, q) {
        ...
        f("column", "line", {
            ...
            crispCol: function(d, f, t, q) {
                ...
                this.options.crisp && (t = Math.round(d + t) + g,
                d = Math.round(d) + g,
                t -= d);
                q = Math.round(f + q) + b;
                g = .5 >= Math.abs(f) && .5 < q;
            ...
            translate: function() {
                ...
                d.points.forEach(function(e) {
                    ...
                    L(e.options.pointWidth) && (q = k = Math.ceil(e.options.pointWidth),
                    a -= Math.round((q - p) / 2));
                    e.barX = a;
                    e.pointWidth = q;
            ...
            pointAttribs: function(d, f) {
                ...
                f && d && (d = H(n.states[f], d.options.states && d.options.states[f] || {}),
                f = d.brightness,
            ...
            drawPoints: function() {
                var d = this, f = this.chart, q = d.options, x = f.renderer, m = q.animationLimit || 250, b;
    ...
    Q(A, "parts/PieSeries.js", [A["parts/Globals.js"], A["mixins/legend-symbol.js"], A["parts/Point.js"], A["parts/Utilities.js"]], function(d, f, A, q) {
        ...
        D("pie", "line", {
            ...
            updateTotals: function() {
                var d, b = 0, f = this.points, n = f.length, h = this.options.ignoreHiddenPoint;
                for (d = 0; d < n; d++) {
                    var e = f[d];
            ...
            redrawPoints: function() {
                var d = this, b = d.chart, f = b.renderer, n, h, e, p, l = d.options.shadow;
                this.drawEmpty();
                ...
                d.points.forEach(function(g) {
                    ...
                    if (!g.isNull && h) {
                        ...
                        g.delayedRendering = !1) : (h.setRadialReference(d.center),
            ...
            setVisible: function(d, b) {
                ...
                b = H(b, e);
                d !== f.visible && (f.visible = f.options.visible = d = "undefined" === typeof d ? !f.visible : d,
            ...
            connectorShapes: {
                ...
                crookedLine: function(d, b, f) {
                    ...
                    f = ["L", e, d.y];
                    h = !0;
                    if ("left" === g ? e > d.x || e < b.x : e < d.x || e > b.x)
                        h = !1;
                    d = [["M", d.x, d.y]];
                    h && d.push(f);
                    d.push(["L", b.x, b.y]);
    ...
    Q(A, "parts/DataLabels.js", [A["parts/Globals.js"], A["parts/Utilities.js"]], function(d, f) {
            ...
            b.some(function(b) {
                ...
                if (b.targets.some(function() {
                    ...
                    if ("undefined" !== typeof m && Math.abs(l[e].pos - l[e].target) > m)
                        return l.slice(0, e + 1).forEach(function(b) {
                            delete b.pos
                        }),
                        l.reducedLen = (l.reducedLen || f) - .1 * f,
                        l.reducedLen > .1 * f && d.distribute(l, f, m),
                        !0;
                    g += l[e].size;
                    e++
                }))
        ...
        N.prototype.drawDataLabels = function() {
            function b(c, a) {
                var b = a.filter;
                return b ? (a = b.operator,
                c = c[b.property],
                b = b.value,
                ">" === a && c > b || "<" === a && c < b || ">=" === a && c >= b || "<=" === a && c <= b || "==" === a && c == b || "===" === a && c === b ? !0 : !1) : !0
            }
            function d(c, a) {
                var b = [], e;
                if (F(c) && !F(a))
                    ...
                    for (e = Math.max(c.length, a.length); e--; )
                        b[e] = H(c[e], a[e]);
                else
                    b = H(c, a);
                return b
            }
            var f = this, h = f.chart, e = f.options, m = e.dataLabels, l = f.points, q, u = f.hasRendered || 0, t = A(e.animation).duration, w = Math.min(t, 200), E = !h.renderer.forExport && D(m.defer, 0 < w), J = h.renderer;
                ...
                l.forEach(function(c) {
                    ...
                    q.forEach(function(a, d) {
                        ...
                        if (g) {
                            ...
                            u = a.style;
                            var v = a.rotation;
                            h.styledMode || (u.color = D(a.color, u.color, f.color, "#000000"),
                            "contrast" === u.color ? (c.contrastColor = J.getContrast(c.color || f.color),
                            u.color = !K(m) && a.inside || 0 > m || e.stacking ? c.contrastColor : "#000000") : delete c.contrastColor,
                            ...
                            h.styledMode || (q.fill = a.backgroundColor,
                        ...
                        !l || g && K(p) ? g && K(p) && (l ? q.text = p : (c.dataLabels = c.dataLabels || [],
                        l = c.dataLabels[d] = v ? J.text(p, 0, -9999, a.useHTML).addClass("highcharts-data-label") : J.label(p, 0, -9999, a.shape, null, null, a.useHTML, null, "data-label"),
                        d || (c.dataLabel = l),
                        l.addClass(" highcharts-data-label-color-" + c.colorIndex + " " + (a.className || "") + (a.useHTML ? " highcharts-tracker" : ""))),
                        l.options = a,
                        l.attr(q),
                        h.styledMode || l.css(u).shadow(a.shadow),
                        l.added || l.add(B),
                        a.textPath && !a.useHTML && (l.setTextPath(c.getDataLabelPath && c.getDataLabelPath(l) || c.graphic, a.textPath),
                        c.dataLabelPath && !a.textPath.enabled && (c.dataLabelPath = c.dataLabelPath.destroy())),
                        f.alignDataLabel(c, l, a, null, n)) : (c.dataLabel = c.dataLabel && c.dataLabel.destroy(),
                        c.dataLabels && (1 === c.dataLabels.length ? delete c.dataLabels : delete c.dataLabels[d]),
                        d || delete c.dataLabel,
                        k && (c.connector = c.connector.destroy(),
        ...
        N.prototype.alignDataLabel = function(b, d, f, h, e) {
            ...
            if (k) {
                ...
                r(q),
                d[e ? "attr" : "animate"](q).attr({
                    align: x
                }),
                r = (w + 720) % 360,
                r = 180 < r && 360 > r,
                "left" === x ? q.y -= r ? t.height : 0 : "center" === x ? (q.x -= t.width / 2,
                q.y -= t.height / 2) : "right" === x && (q.x -= t.width,
                q.y -= r ? 0 : t.height),
                d.placed = !0,
                d.alignAttr = q) : (r(h),
                d.align(f, null, h),
        ...
        N.prototype.justifyDataLabel = function(b, d, f, h, e, m) {
            ...
            var v = f.x + q;
            if (0 > v) {
                "right" === n ? (d.align = "left",
                d.inside = !0) : d.x = -v;
                var t = !0
            }
            v = f.x + h.width - q;
            v > g.plotWidth && ("left" === n ? (d.align = "right",
            d.inside = !0) : d.x = g.plotWidth - v,
            t = !0);
            v = f.y + q;
            0 > v && ("bottom" === p ? (d.verticalAlign = "top",
            d.inside = !0) : d.y = -v,
            t = !0);
            v = f.y + h.height - q;
            v > g.plotHeight && ("top" === p ? (d.verticalAlign = "bottom",
            d.inside = !0) : d.y = g.plotHeight - v,
            t = !0);
            t && (b.placed = !m,
            b.align(d, null, e));
            return t
        ...
        m.pie.prototype.drawDataLabels = function() {
            var b = this, f = b.data, m, h = b.chart, e = b.options.dataLabels || {}, n = e.connectorPadding, l, t = h.plotWidth, u = h.plotHeight, y = h.plotLeft, w = Math.round(h.chartWidth / 3), x, C = b.center, B = C[2] / 2, c = C[1], a, k, r, z, A = [[], []], E, F, L, J, M = [0, 0, 0, 0], Q = b.dataLabelPositioners, O;
            ...
            f.forEach(function(a) {
                ...
                !K(e.style.width) && !K(a.options.dataLabels && a.options.dataLabels.style && a.options.dataLabels.style.width) && a.dataLabel.getBBox().width > w && (a.dataLabel.css({
            ...
            A.forEach(function(f, g) {
                ...
                if (l) {
                    ...
                    if (0 < b.maxLabelDistance) {
                        ...
                        f.forEach(function(a) {
                            0 < a.labelDistance && a.dataLabel && (a.top = Math.max(0, c - B - a.labelDistance),
                    ...
                    for (J = 0; J < l; J++) {
                        ...
                        F = v = r.natural.y;
                        p && K(m.distributeBox) && ("undefined" === typeof m.distributeBox.pos ? L = "hidden" : (z = m.distributeBox.size,
                        F = Q.radialDistributionY(m)));
                        ...
                        r.final.x = E;
                        r.final.y = F;
                        D(e.crop, !0) && (k = a.getBBox().width,
                        v = null,
                        E - k < n && 1 === g ? (v = Math.round(k - E + n),
                        M[3] = Math.max(v, M[3])) : E + k > t - n && 0 === g && (v = Math.round(E + k - t + n),
                        M[1] = Math.max(v, M[1])),
                        0 > F - z / 2 ? M[0] = Math.max(Math.round(-F + z / 2), M[0]) : F + z / 2 > u && (M[2] = Math.max(Math.round(F + z / 2 - u), M[2])),
                        a.sideOverflow = v)
                    }
                }
            }),
            0 === q(M) || this.verifyDataLabelOverflow(M)) && (this.placeDataLabels(),
            this.points.forEach(function(c) {
                ...
                if (l = D(O.connectorWidth, 1)) {
                    ...
                    if ((a = c.dataLabel) && a._pos && c.visible && 0 < c.labelDistance) {
                        ...
                        if (d = !x)
                            c.connector = x = h.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + c.colorIndex + (c.className ? " " + c.className : "")).add(b.dataLabelsGroup),
                            h.styledMode || x.attr({
                                "stroke-width": l,
        ...
        m.pie.prototype.placeDataLabels = function() {
            this.points.forEach(function(b) {
                var d = b.dataLabel, f;
                d && b.visible && ((f = d._pos) ? (d.sideOverflow && (d._attr.width = Math.max(d.getBBox().width - d.sideOverflow, 0),
                d.css({
        ...
        m.pie.prototype.verifyDataLabelOverflow = function(b) {
            ...
            if (!m) {
                if (null !== h[0])
                    var l = Math.max(d[2] - Math.max(b[1], b[3]), e);
                else
                    l = Math.max(d[2] - b[1] - b[3], e),
                    d[0] += (b[3] - b[1]) / 2;
                null !== h[1] ? l = M(l, e, d[2] - Math.max(b[0], b[2])) : (l = M(l, e, d[2] - b[0] - b[2]),
                d[1] += (b[0] - b[2]) / 2);
                l < d[2] ? (d[2] = l,
    ...
    Q(A, "modules/overlapping-datalabels.src.js", [A["parts/Globals.js"], A["parts/Utilities.js"]], function(d, f) {
        ...
        d.prototype.hideOverlappingLabels = function(d) {
            var f = this, A = d.length, E = f.renderer, C, D, w, n = !1;
            var t = function(b) {
                var d, f = b.box ? 0 : b.padding || 0, h = d = 0, e;
            ...
            d.forEach(function(b) {
                if (b) {
                    var d = b.newOpacity;
                    b.oldOpacity !== d && (b.alignAttr && b.placed ? (b[d ? "removeClass" : "addClass"]("highcharts-data-label-hidden"),
                    n = !0,
    ...
    Q(A, "parts/Interaction.js", [A["parts/Globals.js"], A["parts/Legend.js"], A["parts/Point.js"], A["parts/Utilities.js"]], function(d, f, A, q) {
        ...
        var p = d.TrackerMixin = {
            drawTrackerPoint: function() {
                var b = this, d = b.chart, e = d.pointer, f = function(b) {
                    var d = e.getPointFromEvent(b);
                    "undefined" !== typeof d && (e.isDirectTouch = !0,
                    d.onMouseOver(b))
                }, h;
            ...
            drawTrackerGraph: function() {
                ...
                c ? c.attr({
                    ...
                    zIndex: 2
                }).addClass(f ? "highcharts-tracker-area" : "highcharts-tracker-line").add(b.group),
                m.styledMode || b.tracker.attr({
        ...
        x(q.prototype, {
            ...
            zoom: function(b) {
                var d = this, e, f = d.pointer, g = !1, l = d.inverted ? f.mouseDownX : f.mouseDownY;
                ...
                f.initiated = !1) : b.xAxis.concat(b.yAxis).forEach(function(b) {
                    ...
                    if (!h && l >= a && l <= k || h || !L(l))
                        m = !0;
                    f[h ? "zoomX" : "zoomY"] && m && (e = c.zoom(b.min, b.max),
                    c.displayBtn && (g = !0))
                });
            ...
            pan: function(b, e) {
                var f = this, g = f.hoverPoints, l = f.options.chart, h = f.options.mapNavigation && f.options.mapNavigation.enabled, m;
                e = "object" === typeof e ? e : {
                    enabled: e,
                    type: "x"
                };
                    ...
                    c.forEach(function(a) {
                        ...
                        c.series.forEach(function(b) {
                            if (y && !a && (!x || x.isDirty)) {
                                ...
                                D(b.dataMin) && D(b.dataMax) && (x.startMin = Math.min(b.dataMin, x.startMin),
                        ...
                        if (!e.ordinal) {
                            ...
                            if (c.series.length && p !== t.min && v !== t.max && a || x && p >= u && v <= q)
                                c.setExtremes(p, v, !1, !1, {
                                    trigger: "pan"
                                }),
                                f.resetZoomButton || h || !n.match("y") || (f.showResetZoom(),
                                c.displayBtn = !1),
                                m = !0;
                            f[g] = l
                        }
        ...
        x(A.prototype, {
            ...
            setState: function(d, e) {
                var f = this.series, g = this.state, l = f.options.states[d || "normal"] || {}, h = b[f.type].marker && f.options.marker, m = h && !1 === h.enabled, n = h && h.states && h.states[d || "normal"] || {}, c = !1 === n.enabled, a = f.stateMarkerGraphic, k = this.marker || {}, p = f.chart, q = f.halo, t, v = h && f.markerAttribs;
                d = d || "";
                        ...
                        if (d && n) {
                            ...
                            if (t)
                                if (a)
                                    ...
                                    g && (f.stateMarkerGraphic = a = p.renderer.symbol(g, t.x, t.y, t.width, t.height).add(f.markerGroup),
                                    a.currentSymbol = g);
                            !p.styledMode && a && a.attr(f.pointAttribs(this, d))
                        }
                        a && (a[d && this.isInside ? "show" : "hide"](),
                        a.element.point = this)
                    }
                    d = l.halo;
                    l = (a = this.graphic || a) && a.visibility || "inherit";
                    d && d.size && a && "hidden" !== l && !this.isCluster ? (q || (f.halo = q = p.renderer.path().add(a.parentGroup)),
                    q.show()[e ? "animate" : "attr"]({
        ...
        x(v.prototype, {
            ...
            setState: function(b, d) {
                ...
                if (e.state !== b && ([e.group, e.markerGroup, e.dataLabelsGroup].forEach(function(a) {
                    a && (e.state && a.removeClass("highcharts-series-" + e.state),
                ...
                !e.chart.styledMode)) {
                    if (h[b] && !1 === h[b].enabled)
                        return;
                    b && (m = h[b].lineWidth || m + (h[b].lineWidthPlus || 0),
                    c = N(h[b].opacity, c));
                    if (g && !g.dashstyle)
                        for (h = {
                            "stroke-width": m
            ...
            setVisible: function(b, d) {
                ...
                if (f.hoverSeries === e || (f.hoverPoint && f.hoverPoint.series) === e)
                    e.onMouseOut();
    ...
    Q(A, "parts/Responsive.js", [A["parts/Globals.js"], A["parts/Utilities.js"]], function(d, f) {
        ...
        d.prototype.setResponsive = function(d, f) {
            ...
            w = w.toString() || void 0;
            w !== (n && n.ruleIds) && (n && this.update(n.undoOptions, d, !0),
            w ? (n = this.currentOptions(f),
            ...
            function f(d, t, w, m) {
                ...
                J(d, function(d, n) {
                    if (!m && -1 < A.collectionsWithUpdate.indexOf(n))
                        ...
                        b = 0; b < d.length; b++)
                            t[n][b] && (w[n][b] = {},
                            f(d[b], t[n][b], w[n][b], m + 1));
                    else
                        M(d) ? (w[n] = q(d) ? [] : {},
                        f(d, t[n] || {}, w[n], m + 1)) : w[n] = "undefined" === typeof t[n] ? null : t[n]
                })
            }
            var A = this
              , w = {};
