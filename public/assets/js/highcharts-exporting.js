...
*/
(function(g) {
    "object" === typeof module && module.exports ? (g["default"] = g,
    module.exports = g) : "function" === typeof define && define.amd ? define("highcharts/modules/exporting", ["highcharts"], function(n) {
        g(n);
        g.Highcharts = n;
        return g
    ...
    n(g, "modules/full-screen.src.js", [g["parts/Globals.js"], g["parts/Utilities.js"]], function(e, f) {
        ...
        var l = function() {
            ...
            e.prototype.close = function() {
                var k = this.chart;
                if (this.isOpen && this.browserProps && k.container.ownerDocument instanceof Document)
            ...
            e.prototype.setButtonText = function() {
                var e, f = this.chart, g = f.exportDivElements, l = f.options.exporting, q = null === (e = null === l || void 0 === l ? void 0 : l.buttons) || void 0 === e ? void 0 : e.contextButton.menuItems;
                e = f.options.lang;
    ...
    n(g, "modules/exporting.src.js", [g["parts/Globals.js"], g["parts/Utilities.js"], g["mixins/navigation.js"]], function(e, f, g) {
        ...
        w(B.prototype, {
            ...
            print: function() {
                var a = this;
                a.isPrinting || (e.printingChart = a,
            ...
            addButton: function(a) {
                ...
                if (!1 !== d.enabled) {
                    ...
                    k = k && k.select;
                    var z;
                    b.styledMode || (h.fill = t(h.fill, "#ffffff"),
                    ...
                    : f && (z = function(a) {
                        a && a.stopPropagation();
                        b.contextMenu(p.menuClassName, f, p.translateX, p.translateY, p.width, p.height, p);
                        p.setState(2)
                    }
                    );
                    ...
                    b.styledMode || (h["stroke-linecap"] = "round",
        ...
        B.prototype.inlineStyles = function() {
            ...
            var c = this.renderer, d = c.inlineToAttributes, e = c.inlineBlacklist, g = c.inlineWhitelist, f = c.unstyledElements, h = {}, k;
