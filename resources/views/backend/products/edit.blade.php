                    ...
                    <form action="{{ url('products/' . $product->id) }}" class="form-horizontal" method="POST"
                        ...
                        <div class="form-group"><label
                            ...
                            <div class="col-sm-10"><input type="text" class="form-control" id="desc" name="description"
                                    value="{{ old('description', $product->description) }}"></div>
                        </div>
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Category</label>
                            <div class="col-sm-10">
                                <select class="form-control" id="category_id" name="category_id">
                                    ...
                                    <option <?php if($product->category_id == $cat->id) echo "selected"; ?>
                        ...
                        <div class="form-group" id="price_div">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control price_title" id="" name="title[]" value="{{$t}}"
                                    placeholder="Title">
                            </div>
                            <div class="col-sm-2">
                                <input type="text" class="form-control price_amt" id="" name="price[]"
                                    value="{{$prices[$key]}}" placeholder="Price">
                            </div>
                            @if($key == 0)
                            <div class="col-sm-2">
            ...
            <form id="uploadimage" class="text-center" action="" method="post" enctype="multipart/form-data">
                ...
                <label title="Upload image file" for="inputImage" class="">
                    ...
                    <div class="upload-pic img-circle" style="">
                        <img loading="lazy" id="image_source"
                            src="<?php echo url("uploads/products/thumb/" . $product->id . ".jpg?rand=".rand(0,100)); ?>">
                    </div>
